...
public class EmailConstants {
    ...
    public static final String FORGET_PASSWORD_EMAIL_CONTENT = "<p style=\"font-size: 17px;\">          Please click the following link to reset your password        </p>" +
            " </div>    <div style=\"text-align: center\"> <a href=\" %s \"class=\"button\">Reset Password</a> ";
